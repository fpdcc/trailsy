...
var activitiesLayer = function() {
    var activityIcon = L.icon({
        iconUrl: 'img/icon_hike_blue.png',
    ...
    var spec = {
        layerOptions : {
            pointToLayer: function (feature, latlng) {
                return L.marker(latlng, {icon: activityIcon});
            },
    ...
    var _generatePopupContent = function(activity) {
        return "<h5>" + activity.properties.name + "</h5>";
    };
